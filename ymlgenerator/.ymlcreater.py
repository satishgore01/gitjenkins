...
def ipgennrator():
    ...
    file_path = "inputfile.txt"  # Replace with the actual file path
try:
...
existingfile = "/home/ymlfiles/" + new_hostname
try:
...
# Check if 'vars' exists within the specific 'new_hostname' dictionary
    ...
    # Update specific keys within the 'vars' dictionary
        ...
        modified_data['all']['children'][new_hostname]['vars']['ks_ver'] = Ks_Version  # Define host_prefix
...
if 'all' in data and 'children' in data['all'] and 'robin_ms_pri' in data['all']['children']:
    ...
    if new_hostname  in data['all']['children']['robin_ms_pri']['hosts']:
        ...
        data['all']['children']['robin_ms_pri']['hosts'][new_hostname]['os_profile'] = os_profile
